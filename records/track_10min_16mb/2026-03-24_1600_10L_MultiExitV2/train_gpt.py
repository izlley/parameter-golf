...
class GPT(nn.Module):
    def __init__(
        ...
        # Multi-Exit V2: auxiliary norms + learnable logit weights
        ...
        # Learnable weights: initialize with bias toward main exit
        init_weights = torch.zeros(num_exits)
        init_weights[-1] = 1.0  # main exit starts with highest weight
        self.exit_logit_weights = nn.Parameter(init_weights)
        self._init_weights()
    ...
    def forward_logits(self, input_ids: Tensor) -> Tensor:
        ...
        # Learnable weighted average via softmax
        w = F.softmax(self.exit_logit_weights.float(), dim=0)
...
def main() -> None:
    ...
    # Multi-Exit V2: add exit_logit_weights to scalar optimizer
    scalar_params.append(base_model.exit_logit_weights)
