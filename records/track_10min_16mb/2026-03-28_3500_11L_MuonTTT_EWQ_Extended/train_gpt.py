...
def mixed_quantize_int6(state_dict: dict[str, Tensor], int6_cats: set[str]):
    ...
    int5_layers = set(range(min(8, num_layers_total)))
    ...
    for name, tensor in state_dict.items():
        ...
        if cat in int6_cats and t.ndim >= 1:
            # EWQ Extended: determine layer index
            layer_idx = -1
...
def main() -> None:
    ...
    # EWQ Extended: mark layers 0-7 CastedLinear modules for int5 QAT
    for i in range(min(8, len(base_model.blocks))):
