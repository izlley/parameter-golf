...
def mixed_quantize_int6(state_dict: dict[str, Tensor], int6_cats: set[str]):
    ...
    int5_layers = set(range(min(6, num_layers_total)))
...
def main() -> None:
    ...
    # Magnitude pruning: zero out smallest 12% of weights to improve compression
    with torch.no_grad():
