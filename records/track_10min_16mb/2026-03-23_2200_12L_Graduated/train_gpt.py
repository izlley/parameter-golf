...
class Hyperparameters:
    ...
    prune_quantile = float(os.environ.get("PRUNE_QUANTILE", 0.0))
...
def main() -> None:
    ...
    # 12L Graduated: 4 Mini (1.5x, KV1) + 4 Slim (2.5x, KV2) + 4 Full (3.0x, KV4)
    layer_configs = [(1.5, 1)] * 4 + [(2.5, 2)] * 4 + [(3.0, 4)] * 4
